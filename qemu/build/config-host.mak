...
libs_softmmu=-lpixman-1 -lutil -lpng12  -lfdt
GIT=git
...
VERSION=2.12.94
PKGVERSION=
SRC_PATH=/home/uho/workspace/lowriscv_chip/qemu
...
TOOLS=qemu-ga qemu-keymap$(EXESUF) ivshmem-client$(EXESUF) ivshmem-server$(EXESUF) qemu-nbd$(EXESUF) qemu-img$(EXESUF) qemu-io$(EXESUF)  scsi/qemu-pr-helper$(EXESUF)
ROMS=optionrom
MAKE=make
INSTALL=install
...
QEMU_INCLUDES=-iquote $(SRC_PATH)/tcg -iquote $(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/uho/workspace/lowriscv_chip/qemu/build/linux-headers -iquote . -iquote $(SRC_PATH) -iquote $(SRC_PATH)/accel/tcg -iquote $(SRC_PATH)/include
AUTOCONF_HOST := 
