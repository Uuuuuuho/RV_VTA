...
( cd ../../HW/rocket-chip/riscv-tools/riscv-pk/build; ../configure --prefix=$RISCV --host=riscv64-unknown-elf --with-payload=/home/uho/workspace/lowriscv_chip/test/linux-5.8-rc6/vmlinux --enable-logo --enable-print-device-tree)
