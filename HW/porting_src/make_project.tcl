...
# ###########################
	...
	# clk_wiz_0 interface
	connect_bd_net 	[get_bd_pins clk_wiz_0/reset			 ]	[get_bd_pins mig_7series_0/sys_rst				 ]
	...
	connect_bd_net 	[get_bd_pins clk_wiz_0/reset 	       	 ]	[get_bd_pins chip_top_wrapper_0/reset 	       	 ]
