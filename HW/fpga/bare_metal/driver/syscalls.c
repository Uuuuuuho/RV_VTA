...
void external_interrupt_sys(void){
...
void _init(int cid, int nc)
{
  ...
  */
  ...
  mac_addr.addr[1] = (uint8_t)0x0A;
  mac_addr.addr[2] = (uint8_t)0x35;
  mac_addr.addr[3] = (uint8_t)0x02;
  mac_addr.addr[4] = (uint8_t)0xF0;
  mac_addr.addr[5] = (uint8_t)(0xD7|(sw >> 12));
