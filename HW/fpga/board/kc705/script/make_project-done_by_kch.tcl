...
#startgroup
#
#   create_bd_cell -type module -reference chip_top_wrapper chip_top_without_mig_clkwiz_0
...
#   connect_bd_net [get_bd_ports rst_top      ] [get_bd_pins chip_top_without_mig_clkwiz_0/rst_top]
...
#
#   connect_bd_net [get_bd_ports rxd          ] [get_bd_pins chip_top_without_mig_clkwiz_0/rxd     ]
#   connect_bd_net [get_bd_ports txd          ] [get_bd_pins chip_top_without_mig_clkwiz_0/txd     ]
#   connect_bd_net [get_bd_ports rts          ] [get_bd_pins chip_top_without_mig_clkwiz_0/rts     ]
#   connect_bd_net [get_bd_ports cts          ] [get_bd_pins chip_top_without_mig_clkwiz_0/cts     ]
#   
#   connect_bd_net [get_bd_ports sd_sclk      ] [get_bd_pins chip_top_without_mig_clkwiz_0/sd_sclk   ]
#   connect_bd_net [get_bd_ports sd_detect    ] [get_bd_pins chip_top_without_mig_clkwiz_0/sd_detect ]
#   connect_bd_net [get_bd_ports sd_dat       ] [get_bd_pins chip_top_without_mig_clkwiz_0/sd_dat    ]
#   connect_bd_net [get_bd_ports sd_cmd       ] [get_bd_pins chip_top_without_mig_clkwiz_0/sd_cmd    ]
#   connect_bd_net [get_bd_ports sd_reset     ] [get_bd_pins chip_top_without_mig_clkwiz_0/sd_reset  ]
#   
#   connect_bd_net [get_bd_ports o_led        ] [get_bd_pins chip_top_without_mig_clkwiz_0/o_led     ]
#   connect_bd_net [get_bd_ports i_dip        ] [get_bd_pins chip_top_without_mig_clkwiz_0/i_dip     ]
#
#   connect_bd_net [get_bd_ports GPIO_SW_C    ] [get_bd_pins chip_top_without_mig_clkwiz_0/GPIO_SW_C ]
#   connect_bd_net [get_bd_ports GPIO_SW_W    ] [get_bd_pins chip_top_without_mig_clkwiz_0/GPIO_SW_W ]
#   connect_bd_net [get_bd_ports GPIO_SW_E    ] [get_bd_pins chip_top_without_mig_clkwiz_0/GPIO_SW_E ]
#   connect_bd_net [get_bd_ports GPIO_SW_N    ] [get_bd_pins chip_top_without_mig_clkwiz_0/GPIO_SW_N ]
#   connect_bd_net [get_bd_ports GPIO_SW_S    ] [get_bd_pins chip_top_without_mig_clkwiz_0/GPIO_SW_S ]
#
#   connect_bd_net [get_bd_ports PS2_CLK      ] [get_bd_pins chip_top_without_mig_clkwiz_0/PS2_CLK   ]
#   connect_bd_net [get_bd_ports PS2_DATA     ] [get_bd_pins chip_top_without_mig_clkwiz_0/PS2_DATA  ]
#
#   connect_bd_net [get_bd_ports i_erx_dv     ] [get_bd_pins chip_top_without_mig_clkwiz_0/i_erx_dv  ]
#   connect_bd_net [get_bd_ports i_erx_er     ] [get_bd_pins chip_top_without_mig_clkwiz_0/i_erx_er  ]
#   connect_bd_net [get_bd_ports i_emdint     ] [get_bd_pins chip_top_without_mig_clkwiz_0/i_emdint  ]
#   connect_bd_net [get_bd_ports o_erefclk    ] [get_bd_pins chip_top_without_mig_clkwiz_0/o_erefclk ]
#   connect_bd_net [get_bd_ports o_etx_en     ] [get_bd_pins chip_top_without_mig_clkwiz_0/o_etx_en  ]
#
#   connect_bd_net [get_bd_ports i_erxd       ] [get_bd_pins chip_top_without_mig_clkwiz_0/i_erxd     ]
#   connect_bd_net [get_bd_ports o_etxd       ] [get_bd_pins chip_top_without_mig_clkwiz_0/o_etxd     ]
#   connect_bd_net [get_bd_ports o_etx_er     ] [get_bd_pins chip_top_without_mig_clkwiz_0/o_etx_er   ]
#   connect_bd_net [get_bd_ports i_gmiiclk_p  ] [get_bd_pins chip_top_without_mig_clkwiz_0/i_gmiiclk_p]
#   connect_bd_net [get_bd_ports i_gmiiclk_n  ] [get_bd_pins chip_top_without_mig_clkwiz_0/i_gmiiclk_n]
#   connect_bd_net [get_bd_ports i_erx_clk    ] [get_bd_pins chip_top_without_mig_clkwiz_0/i_erx_clk  ]
#   connect_bd_net [get_bd_ports i_etx_clk    ] [get_bd_pins chip_top_without_mig_clkwiz_0/i_etx_clk  ]
#      
#   connect_bd_net [get_bd_ports o_emdc       ] [get_bd_pins chip_top_without_mig_clkwiz_0/o_emdc     ]
#   connect_bd_net [get_bd_ports io_emdio     ] [get_bd_pins chip_top_without_mig_clkwiz_0/io_emdio   ]
#   connect_bd_net [get_bd_ports o_erstn      ] [get_bd_pins chip_top_without_mig_clkwiz_0/o_erstn    ]
#
#save_bd_design
#
#endgroup
