...
save_bd_design
  ...
  # set_property -dict [list CONFIG.POLARITY {ACTIVE_HIGH}] [get_bd_pins chip_top_mod_wrapper_0/clk_wiz1_rstn]
  # connect_bd_net [get_bd_pins clk_wiz_1/reset          		] [get_bd_pins chip_top_mod_wrapper_0/clk_wiz1_rst     	]
