...
set files [list \
               ...
               [file normalize $base_dir/src/main/verilog/chip_top_mmio_bram_port.sv] \
...
add_files -norecurse -scan_for_includes /home/uho/workspace/lowriscv_chip/HW/porting_src/src/main/verilog/chip_top_mod_wrapper_mmio_bram_port.v
import_files -norecurse /home/uho/workspace/lowriscv_chip/HW/porting_src/src/main/verilog/chip_top_mod_wrapper_mmio_bram_port.v
...
#  create_bd_cell -type module -reference chip_top_mod_wrapper_wo_clk_conv chip_top_mod_wrapper_0
  create_bd_cell -type module -reference chip_top_mod_wrapper_mmio_bram_port chip_top_mod_wrapper_0
...
set_property CONFIG.XML_INPUT_FILE \
		[file normalize /home/uho/workspace/lowriscv_chip/HW/fpga/board/nexys4_ddr/script/mig_config.prj] \
...
#  connect_bd_net [get_bd_ports ddr_reset_n  ] [get_bd_pins mig_7series_0/ddr2_reset_n 		]
  ...
  connect_bd_net [get_bd_pins mig_7series_0/ui_addn_clk_0			] [get_bd_pins chip_top_mod_wrapper_0/clk    	]
  ...
  # external<=>clk_wiz0&1
  connect_bd_net [get_bd_ports rst_top					] [get_bd_pins clk_wiz_0/resetn]
  connect_bd_net [get_bd_pins clk_wiz_0/clk_in1         ] [get_bd_pins mig_7series_0/ui_clk				    ]
  connect_bd_net [get_bd_pins clk_wiz_0/clk_rmii        ] [get_bd_pins chip_top_mod_wrapper_0/clk_mii       ]
...
#  connect_bd_net [get_bd_pins clk_wiz_0/reset            	] [get_bd_ports chip_top_mod_wrapper_0/rst_top      ]	 
#  connect_bd_net [get_bd_ports clk_wiz_0/clk_rmii_quad            ] [get_bd_pins chip_top_mod_wrapper_0/clk_mii_quad  	]
...
#  connect_bd_net [get_bd_pins clk_wiz_1/clk_in1             ] [get_bd_pins chip_top_mod_wrapper_0/clk             	]
  connect_bd_net [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins clk_wiz_1/clk_in1]
...
#  connect_bd_net		[get_bd_pins clk_wiz_0/clk_rmii						] [get_bd_pins axi_clock_converter_0/s_axi_aclk		]
  connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_aclk] [get_bd_pins mig_7series_0/ui_addn_clk_0]
  ...
  connect_bd_net -boundary_type upper \
 		[get_bd_pins axi_interconnect_1/ACLK] \
 		[get_bd_pins axi_interconnect_1/S00_ACLK] \
 		[get_bd_pins axi_interconnect_1/M00_ACLK]
  connect_bd_net [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins clk_wiz_0/clk_rmii]
  ...
  connect_bd_net [get_bd_pins util_vector_logic_1/Res] [get_bd_pins axi_interconnect_1/ARESETN]
  connect_bd_net [get_bd_pins util_vector_logic_1/Op1] [get_bd_pins mig_7series_0/mmcm_locked]
...
#     set_property -dict [list CONFIG.NUM_SI {1} CONFIG.NUM_MI {2}] [get_bd_cells axi_interconnect_1]
  
#     disconnect_bd_net /ARESETN_1 [get_bd_pins util_vector_logic_1/Res]
#     disconnect_bd_net /Net9 [get_bd_pins util_vector_logic_1/Op1]
# 	connect_bd_net [get_bd_pins axi_interconnect_1/M01_ACLK         ] [get_bd_pins clk_wiz_0/clk_cpu					]
#     connect_bd_net [get_bd_pins axi_interconnect_1/M01_ARESETN      ] [get_bd_pins axi_interconnect_1/M00_ARESETN		] -boundary_type upper
#     connect_bd_net [get_bd_pins axi_interconnect_1/ARESETN			] [get_bd_pins mig_7series_0/mmcm_locked			]
...
#     connect_bd_net [get_bd_pins proc_sys_reset/ext_reset_in] [get_bd_pins mig_7series_0/mmcm_locked]
	
# 	assign_bd_address

#     set_property range 256K [get_bd_addr_segs {chip_top_mod_wrapper_0/mmio_m_axi/SEG_chip_top_mod_wrapper_0_reg0}]
#     set_property offset 0x40000000 [get_bd_addr_segs {chip_top_mod_wrapper_0/mmio_m_axi/SEG_chip_top_mod_wrapper_0_reg0}]
#     set_property range 4K [get_bd_addr_segs {chip_top_mod_wrapper_0/mmio_m_axi/SEG_compute_0_Reg}]
#     set_property range 4K [get_bd_addr_segs {chip_top_mod_wrapper_0/mmio_m_axi/SEG_fetch_0_Reg}]
#     set_property range 4K [get_bd_addr_segs {chip_top_mod_wrapper_0/mmio_m_axi/SEG_load_0_Reg}]
#     set_property range 4K [get_bd_addr_segs {chip_top_mod_wrapper_0/mmio_m_axi/SEG_store_0_Reg}]
#     set_property offset 0x40080000 [get_bd_addr_segs {chip_top_mod_wrapper_0/mmio_m_axi/SEG_compute_0_Reg}]
#     set_property offset 0x40081000 [get_bd_addr_segs {chip_top_mod_wrapper_0/mmio_m_axi/SEG_fetch_0_Reg}]
#     set_property offset 0x40082000 [get_bd_addr_segs {chip_top_mod_wrapper_0/mmio_m_axi/SEG_load_0_Reg}]
#     set_property offset 0x40083000 [get_bd_addr_segs {chip_top_mod_wrapper_0/mmio_m_axi/SEG_store_0_Reg}]
#     assign_bd_address [get_bd_addr_segs {mig_7series_0/memmap/memaddr }]
...
# DEBUGGING MODULE ATTACHED.
#    add_files -norecurse -scan_for_includes /home/uho/workspace/lowriscv_chip/HW/porting_src/src/main/verilog/bram_port_debugging.v
#    import_files -norecurse /home/uho/workspace/lowriscv_chip/HW/porting_src/src/main/verilog/bram_port_debugging.v
#    create_bd_cell -type module -reference bram_port_debugging bram_port_debugging_0
#    connect_bd_net [get_bd_pins bram_port_debugging_0/clk] [get_bd_pins clk_wiz_0/clk_cpu]
#    
#    
#    connect_bd_net [get_bd_pins bram_port_debugging_0/awvalid] [get_bd_pins axi_interconnect_1/M01_AXI_awvalid]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/arvalid] [get_bd_pins axi_interconnect_1/M01_AXI_arvalid]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/awaddr ] [get_bd_pins axi_interconnect_1/M01_AXI_awaddr ]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/araddr ] [get_bd_pins axi_interconnect_1/M01_AXI_araddr ]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/awready] [get_bd_pins chip_top_mod_wrapper_0/Inter_to_Bram_axi_awready]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/arready] [get_bd_pins chip_top_mod_wrapper_0/Inter_to_Bram_axi_arready]
#    
#    
#    
#    connect_bd_net [get_bd_pins bram_port_debugging_0/awvalid] [get_bd_pins axi_interconnect_1/S00_AXI_awvalid]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/arvalid] [get_bd_pins axi_interconnect_1/S00_AXI_arvalid]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/awaddr ] [get_bd_pins axi_interconnect_1/S00_AXI_awaddr ]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/araddr ] [get_bd_pins axi_interconnect_1/S00_AXI_araddr ]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/awready] [get_bd_pins chip_top_mod_wrapper_0/mmio_m_axi_awready]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/arready] [get_bd_pins chip_top_mod_wrapper_0/mmio_m_axi_arready]
#    
#    
#    # ##########################
#    # another trying
...
#    
#    
#    connect_bd_net [get_bd_pins bram_port_debugging_0/awvalid] [get_bd_pins axi_interconnect_1/M00_AXI_awvalid]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/arvalid] [get_bd_pins axi_interconnect_1/M00_AXI_arvalid]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/awaddr ] [get_bd_pins axi_interconnect_1/M00_AXI_awaddr ]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/araddr ] [get_bd_pins axi_interconnect_1/M00_AXI_araddr ]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/awready] [get_bd_pins chip_top_mod_wrapper_0/Inter_to_Bram_axi_awready]
#    connect_bd_net [get_bd_pins bram_port_debugging_0/arready] [get_bd_pins chip_top_mod_wrapper_0/Inter_to_Bram_axi_arready]
#    
#    
#    connect_bd_net [get_bd_pins axi_interconnect_1/M00_AXI_awvalid] [get_bd_pins chip_top_mod_wrapper_0/Inter_to_Bram_axi_awvalid]
#    connect_bd_net [get_bd_pins axi_interconnect_1/M00_AXI_arvalid] [get_bd_pins chip_top_mod_wrapper_0/Inter_to_Bram_axi_arvalid]
#    connect_bd_net [get_bd_pins axi_interconnect_1/M00_AXI_awaddr ] [get_bd_pins chip_top_mod_wrapper_0/Inter_to_Bram_axi_awaddr]
#    connect_bd_net [get_bd_pins axi_interconnect_1/M00_AXI_araddr ] [get_bd_pins chip_top_mod_wrapper_0/Inter_to_Bram_axi_araddr]
