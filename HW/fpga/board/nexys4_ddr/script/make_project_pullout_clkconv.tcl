...
set_property CONFIG.XML_INPUT_FILE [file normalize /home/uho/workspace/lowriscv_chip/HW/fpga/board/nexys4_ddr/script/mig_config.prj] [get_bd_cells mig_7series_0]
...
save_bd_design
  ...
  connect_bd_net [get_bd_ports clk_p        ] [get_bd_pins mig_7series_0/sys_clk_i   		]
  connect_bd_net [get_bd_ports ddr_dq       ] [get_bd_pins mig_7series_0/ddr2_dq      		]
  connect_bd_net [get_bd_ports ddr_dqs_n    ] [get_bd_pins mig_7series_0/ddr2_dqs_n   		]
  connect_bd_net [get_bd_ports ddr_dqs_p    ] [get_bd_pins mig_7series_0/ddr2_dqs_p   		]
  connect_bd_net [get_bd_ports ddr_addr     ] [get_bd_pins mig_7series_0/ddr2_addr    		]
  connect_bd_net [get_bd_ports ddr_ba       ] [get_bd_pins mig_7series_0/ddr2_ba      		]
  connect_bd_net [get_bd_ports ddr_ras_n    ] [get_bd_pins mig_7series_0/ddr2_ras_n   		]
  connect_bd_net [get_bd_ports ddr_cas_n    ] [get_bd_pins mig_7series_0/ddr2_cas_n   		]
  connect_bd_net [get_bd_ports ddr_we_n     ] [get_bd_pins mig_7series_0/ddr2_we_n    		]
  connect_bd_net [get_bd_ports ddr_ck_n     ] [get_bd_pins mig_7series_0/ddr2_ck_n    		]
  connect_bd_net [get_bd_ports ddr_ck_p     ] [get_bd_pins mig_7series_0/ddr2_ck_p    		]
  connect_bd_net [get_bd_ports ddr_cke      ] [get_bd_pins mig_7series_0/ddr2_cke     		]
  connect_bd_net [get_bd_ports ddr_cs_n     ] [get_bd_pins mig_7series_0/ddr2_cs_n    		]
  connect_bd_net [get_bd_ports ddr_dm       ] [get_bd_pins mig_7series_0/ddr2_dm      		]
  connect_bd_net [get_bd_ports ddr_odt      ] [get_bd_pins mig_7series_0/ddr2_odt     		]
  ...
  # connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins chip_top_mod_wrapper_0/mig_s_axi]
  # connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins mig_7series_0/S_AXI]
  ...
  # #  port mapping
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_awvalid      ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_awvalid           ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_awready      ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_awready           ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_awaddr       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_awaddr       	 ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_awlen        ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_awlen        	 ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_awsize       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_awsize       	 ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_awburst      ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_awburst      	 ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_awlock       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_awlock       	 ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_awcache      ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_awcache      	 ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_awprot       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_awprot       	 ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_awqos        ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_awqos        	 ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_wvalid       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_wvalid            ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_wready       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_wready            ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_wdata        ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_wdata        	 ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_wstrb        ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_wstrb        	 ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_wlast        ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_wlast        	 ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_bvalid       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_bvalid            ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_bready       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_bready            ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_bresp        ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_bresp        	 ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_arvalid      ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_arvalid          ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_arready      ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_arready          ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_araddr       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_araddr      ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_arlen        ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_arlen       ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_arsize       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_arsize      ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_arburst      ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_arburst     ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_arlock       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_arlock      ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_arcache      ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_arcache     ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_arprot       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_arprot      ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_arqos        ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_arqos       ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_rvalid       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_rvalid           ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_rready       ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_rready           ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_rdata        ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_rdata       ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_rresp        ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_rresp       ]
  # connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_rlast        ] [get_bd_pins chip_top_mod_wrapper_0/mem_m_rlast       ]

  connect_bd_net [get_bd_pins axi_clock_converter_0/s_axi_aclk          ] [get_bd_pins clk_wiz_0/clk_rmii            		]
  ...
  # set_property offset 0x80000000 [get_bd_addr_segs {chip_top_mod_wrapper_0/mig_s_axi/SEG_mig_7series_0_memaddr}]
  # set_property range 1G [get_bd_addr_segs {chip_top_mod_wrapper_0/mig_s_axi/SEG_mig_7series_0_memaddr}]
...
# ########################
  ...
  make_wrapper -files [get_files /home/uho/workspace/lowriscv_chip/HW/fpga/board/nexys4_ddr/lowrisc-chip-imp/lowrisc-chip-imp.srcs/sources_1/bd/RISC_V_SOC/RISC_V_SOC.bd] -top
  add_files -norecurse /home/uho/workspace/lowriscv_chip/HW/fpga/board/nexys4_ddr/lowrisc-chip-imp/lowrisc-chip-imp.srcs/sources_1/bd/RISC_V_SOC/hdl/RISC_V_SOC_wrapper.v
  update_compile_order -fileset sources_1
